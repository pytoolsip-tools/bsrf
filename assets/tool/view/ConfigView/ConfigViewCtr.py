...
class ConfigViewCtr(object):
	"""docstring for ConfigViewCtr"""
	def __init__(self, parent, params = {}):
		super(ConfigViewCtr, self).__init__();
		self._className_ = ConfigViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = ConfigViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
