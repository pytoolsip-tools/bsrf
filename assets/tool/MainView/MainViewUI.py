...
class MainViewUI(wx.ScrolledWindow):
	...
	def createControls(self):
		self.getCtr().createCtrByKey("ContentView", self._curPath + "../view/ContentView"); # , parent = self, params = {}
		self.getCtr().createCtrByKey("ConfigView", self._curPath + "../view/ConfigView");
		pass;
		
	def initViewLayout(self):
		box = wx.BoxSizer(wx.HORIZONTAL);
		box.Add(self.getCtr().getUIByKey("ContentView"));
		box.Add(self.getCtr().getUIByKey("ConfigView"));
		self.SetSizer(box);
